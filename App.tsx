                ...
                <div className="text-center mb-10 animate-fade-in-down">
                  ...
                  <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-4 relative z-20">
                    ...
                    <div className="flex-grow-[2] relative">
                        ...
                        className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition-all"
                        value={searchTerm}
